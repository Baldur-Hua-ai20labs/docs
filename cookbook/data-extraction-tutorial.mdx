...
├── video-script.md   # ~6 min recording script
└── social-promotion.md
```
...
**Video:** Record using the [video script](https://github.com/zerogpu/docs/blob/main/tutorials/data-extraction/video-script.md). **Social:** Copy from [social-promotion.md](https://github.com/zerogpu/docs/blob/main/tutorials/data-extraction/social-promotion.md).
