...
The API returns the classification in the standard [Responses API](/api-reference/responses) format. The model output is **JSON** with:
...
- Store API key and project ID in environment variables; see [Security](/docs/platform#api-keys).
