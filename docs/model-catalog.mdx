...
export const SEED_MODELS = [
  ...
  {
    "modelId": "zlm-v1-followup-questions-edge",
...
export const PricingTable = () => {
  ...
  const cols = {
    display: "grid",
    gridTemplateColumns:
      "minmax(0,2.2fr) minmax(0,1.4fr) minmax(0,0.7fr) minmax(0,1fr) minmax(0,0.9fr) minmax(0,0.9fr)",
    gap: "1rem",
    alignItems: "center",
    minWidth: "760px",
  };
  return (
    <div className="not-prose w-full overflow-x-auto text-base">
      ...
      {models.map((m) => (
        <a
          key={m.modelId}
          href={"/models/" + modelSlug(m.modelId)}
          style={cols}
          className="border-b border-zinc-950/5 py-3.5 no-underline dark:border-white/5"
        >
          <div className="flex items-center gap-2 font-medium text-zinc-950 dark:text-white">
            ...
            <code className="whitespace-nowrap text-sm">{m.modelId}</code>
          </div>
