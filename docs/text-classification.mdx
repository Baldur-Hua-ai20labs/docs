...
Text classification models map a passage to predefined labels or categories. ZeroGPU offers IAB taxonomy classifiers tuned for ad tech plus a general zero-shot classifier where you supply the candidate labels. Each request is shown for both the [Responses API](/api-reference/endpoint/responses) and the OpenAI-compatible [Chat Completions API](/api-reference/endpoint/chat-completions).

| Model | Params | Max tokens | Input /1M | Output /1M |
| --- | --- | --- | --- | --- |
| [`zlm-v1-iab-classify-edge-enriched`](/models/zlm-v1-iab-classify-edge-enriched) | 90M | 400 | $0.05 | $0.40 |
| [`zlm-v1-iab-classify-edge`](/models/zlm-v1-iab-classify-edge) | 90M | 400 | $0.05 | $0.40 |
| [`deberta-v3-small`](/models/deberta-v3-small) | 142M | 400 | $0.05 | $0.40 |
